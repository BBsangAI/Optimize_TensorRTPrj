...
string getEnginePath(string onnxPath, string tag) {
    ...
    string enginePath = onnxPath.substr(0, name_l); // 获取 `../model`
    enginePath += "/engine";                         // `../model/engine`
    enginePath += onnxPath.substr(name_l, name_r - name_l); // `/gesture_7classification_model_MEMATsmv1`
    enginePath += "-" + tag + ".engine";   // `../model/engine/gesture_7classification_model_MEMATsmv1-fp16.engine`
